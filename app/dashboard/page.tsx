  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-800 to-red-950">
      <header className="flex items-center justify-between p-4">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-56 bg-gray-800 border-gray-700" align="end" forceMount>
            ...
            <DropdownMenuItem className="text-gray-300 hover:bg-gray-700 hover:text-white cursor-pointer" onClick={() => setIsProfileModalOpen(true)}><Settings className="mr-2 h-4 w-4" /><span>Settings</span></DropdownMenuItem>
            <DropdownMenuSeparator className="bg-gray-700" />
      ...
      <main className="px-4 pb-8">
        {activeTab === 'explore' && <div className="max-w-6xl mx-auto">{/* Explore Content */}</div>}
        {activeTab === 'chat' && (
      ...
      {expandedMedia && <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4">{/* Expanded Media Modal */}</div>}
